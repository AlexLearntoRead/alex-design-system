---
name: alex-design-system
description: Alex 的个人品牌设计系统。做HTML页面、个人网站、教程页面、介绍页面、landing page等任何前端设计时自动触发。包含品牌DNA和多个场景子规范。
---

触发条件：当用户要求制作HTML网页、个人页面、教程页面、介绍型页面、landing page、活动页面、App型页面、作品集、小红书图文卡片、公众号排版等任何前端设计相关任务时触发。
...
- **公众号排版** → `assets/template-wechat.html`
...
## 头像规范
- IP头像固定为 Alex 形象：`assets/avatar.jpg`
- 所有页面、卡片中统一使用此头像
- 署名统一为「Alex」+ 「LTR 家庭英语 · 结构化读写」

## 禁忌
严格遵守 `brand-dna.md` 的禁忌清单，不在此重复。核心底线：截图发社交媒体不会被说"又是AI做的"。