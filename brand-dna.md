...
> ⚠️ **使用前请确认配置：** 下面是默认三色配色，可直接使用。如需换成你自己的品牌色，替换三个色值并同步修改模板 `:root` 变量。
...
### 使用规则
- 所有卡片、页面中固定使用 `assets/avatar.jpg` 作为头像
- 头像为 Alex 本人形象，不可替换
- 圆形裁剪，边框使用品牌黄 `#F4D758`
